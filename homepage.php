...
<div class="container rowmine">
    ...
    if ($isWorker) {
        ...
        if ($val == 'f') {
            ...
            $query = pg_query_params($connection, $query, array($_SESSION['login_user']));
            $queryInner = "UPDATE p4c.task SET result = FALSE WHERE campaign = $1 AND requester = $2 AND result IS NULL";
