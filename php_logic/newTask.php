...
$done = pg_query_params($connection, $query, array($titlemodified, $description, $workers, $tresh, $requester, $campaign));

$query = "SELECT id FROM p4c.task WHERE titolo=$1";
$done = pg_query_params($connection, $query, array($titlemodified));
